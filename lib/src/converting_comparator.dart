...
import 'conversion_service/conversion_service_converter.dart';
...
class _MapEntryValueConverter<K, V> extends Converter<MapEntry<K, V>, V> {
...
class _MapEntryKeyConverter<K, V> extends Converter<MapEntry<K, V>, K> {
