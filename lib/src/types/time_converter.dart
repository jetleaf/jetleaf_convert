...
/// ```
class StringToDateTimeConverter extends Converter<String, DateTime> {
  @override
  DateTime convert(String input) {
    try {
      return DateTime.parse(input);
    } catch (e) {
      throw ConversionException('Failed to parse DateTime from string: $input. $e');
    }
  }
}
...
/// ```
class DateTimeToStringConverter extends Converter<DateTime, String> {
  @override
...
/// ```
class StringToLocalDateTimeConverter extends Converter<String, LocalDateTime> {
  @override
  LocalDateTime convert(String input) {
    try {
      return LocalDateTime.parse(input);
    } catch (e) {
      throw ConversionException('Failed to parse LocalDateTime from string: $input. $e');
    }
  }
}
...
/// ```
class LocalDateTimeToStringConverter extends Converter<LocalDateTime, String> {
  @override
...
/// ```
class StringToLocalDateConverter extends Converter<String, LocalDate> {
  @override
  LocalDate convert(String input) {
    try {
      return LocalDate.parse(input);
    } catch (e) {
      throw ConversionException('Failed to parse LocalDate from string: $input. $e');
    }
  }
}
...
/// ```
class LocalDateToStringConverter extends Converter<LocalDate, String> {
  @override
...
/// ```
class StringToLocalTimeConverter extends Converter<String, LocalTime> {
  @override
  LocalTime convert(String input) {
    try {
      return LocalTime.parse(input);
    } catch (e) {
      throw ConversionException('Failed to parse LocalTime from string: $input. $e');
    }
  }
}
...
/// ```
class LocalTimeToStringConverter extends Converter<LocalTime, String> {
  @override
...
/// ```
class StringToZoneIdConverter extends Converter<String, ZoneId> {
  @override
  ZoneId convert(String input) {
    try {
      return ZoneId.of(input);
    } catch (e) {
      throw ConversionException('Failed to create ZoneId from string: $input. $e');
    }
  }
}
...
/// ```
class ZoneIdToStringConverter extends Converter<ZoneId, String> {
  @override
...
/// ```
class StringToZonedDateTimeConverter extends Converter<String, ZonedDateTime> {
  @override
  ZonedDateTime convert(String input) {
    try {
      return ZonedDateTime.parse(input);
    } catch (e) {
      throw ConversionException('Failed to parse ZonedDateTime from string: $input. $e');
    }
  }
}
...
/// ```
class ZonedDateTimeToStringConverter extends Converter<ZonedDateTime, String> {
  @override
...
/// ```
class StringToDurationConverter extends Converter<String, Duration> {
  @override
  Duration convert(String input) {
    try {
      ...
      throw ConversionException('Failed to parse Duration from string: $input. $e');
    }
  }
}
...
/// ```
class DurationToStringConverter extends Converter<Duration, String> {
  @override
...
/// ```
class DateTimeToLocalDateTimeConverter extends Converter<DateTime, LocalDateTime> {
  @override
...
/// ```
class LocalDateTimeToDateTimeConverter extends Converter<LocalDateTime, DateTime> {
  @override
...
/// ```
class DateTimeToLocalDateConverter extends Converter<DateTime, LocalDate> {
  @override
...
/// ```
class LocalDateToDateTimeConverter extends Converter<LocalDate, DateTime> {
  @override
...
/// ```
class DateTimeToLocalTimeConverter extends Converter<DateTime, LocalTime> {
  @override
...
/// ```
class DateTimeToZonedDateTimeConverter extends Converter<DateTime, ZonedDateTime> {
...
/// ```
class ZonedDateTimeToDateTimeConverter extends Converter<ZonedDateTime, DateTime> {
  @override
...
/// ```
class IntToDateTimeConverter extends Converter<int, DateTime> {
  @override
  DateTime convert(int input) {
    try {
      return DateTime.fromMillisecondsSinceEpoch(input);
    } catch (e) {
      throw ConversionException('Failed to create DateTime from epoch milliseconds: $input. $e');
    }
  }
}
...
/// ```
class DateTimeToIntConverter extends Converter<DateTime, int> {
  @override
...
/// ```
class IntToZonedDateTimeConverter extends Converter<int, ZonedDateTime> {
  final ZoneId? defaultZone;
...
/// ```
class ZonedDateTimeToIntConverter extends Converter<ZonedDateTime, int> {
  @override
...
/// ```
class IntToDurationConverter extends Converter<int, Duration> {
  @override
...
/// ```
class DurationToIntConverter extends Converter<Duration, int> {
  @override
...
/// ```
class LocalDateTimeToLocalDateConverter extends Converter<LocalDateTime, LocalDate> {
  @override
...
/// ```
class LocalDateTimeToLocalTimeConverter extends Converter<LocalDateTime, LocalTime> {
  @override
...
/// ```
class LocalDateAndLocalTimeToLocalDateTimeConverter extends Converter<List<dynamic>, LocalDateTime> {
  @override
  LocalDateTime convert(List<dynamic> input) {
    if (input.length != 2) {
      throw ConversionException('Expected exactly 2 elements: [LocalDate, LocalTime]');
    }
    
    if (input[0] is! LocalDate || input[1] is! LocalTime) {
      throw ConversionException('Expected [LocalDate, LocalTime]');
    }
...
/// ```
class LocalDateTimeToZonedDateTimeConverter extends Converter<LocalDateTime, ZonedDateTime> {
  final ZoneId zone;
...
/// ```
class ZonedDateTimeToLocalDateTimeConverter extends Converter<ZonedDateTime, LocalDateTime> {
  @override
...
/// ```
class ZonedDateTimeToLocalDateConverter extends Converter<ZonedDateTime, LocalDate> {
  @override
...
/// ```
class ZonedDateTimeToLocalTimeConverter extends Converter<ZonedDateTime, LocalTime> {
  @override
...
/// ```
class ZonedDateTimeToZoneIdConverter extends Converter<ZonedDateTime, ZoneId> {
  @override
...
/// Converts `List<String>` to `List<DateTime>`
/// 
/// Example:
/// ```dart
/// final converter = ListStringToListDateTimeConverter();
/// final dateTimes = converter.convert(['2023-12-25T15:30:00Z', '2023-12-26T10:00:00Z']);
/// ```
class ListStringToListDateTimeConverter extends Converter<List<String>, List<DateTime>> {
  @override
  List<DateTime> convert(List<String> input) {
    final stringConverter = StringToDateTimeConverter();
    return input.map((str) => stringConverter.convert(str)).toList();
  }
}

/// Converts `List<DateTime>` to `List<String>`
/// 
/// Example:
/// ```dart
/// final converter = ListDateTimeToListStringConverter();
/// final strings = converter.convert([DateTime.now(), DateTime.now().add(Duration(days: 1))]);
/// ```
class ListDateTimeToListStringConverter extends Converter<List<DateTime>, List<String>> {
  @override
  List<String> convert(List<DateTime> input) {
    final dateTimeConverter = DateTimeToStringConverter();
    return input.map((dt) => dateTimeConverter.convert(dt)).toList();
  }
}

/// Converts `List<String>` to `List<LocalDateTime>`
/// 
/// Example:
/// ```dart
/// final converter = ListStringToListLocalDateTimeConverter();
/// final localDateTimes = converter.convert(['2023-12-25T15:30:00', '2023-12-26T10:00:00']);
/// ```
class ListStringToListLocalDateTimeConverter extends Converter<List<String>, List<LocalDateTime>> {
  @override
  List<LocalDateTime> convert(List<String> input) {
    final stringConverter = StringToLocalDateTimeConverter();
    return input.map((str) => stringConverter.convert(str)).toList();
  }
}

/// Converts `List<LocalDateTime>` to `List<String>`
/// 
/// Example:
/// ```dart
/// final converter = ListLocalDateTimeToListStringConverter();
/// final strings = converter.convert([LocalDateTime.now(), LocalDateTime.now().plusDays(1)]);
/// ```
class ListLocalDateTimeToListStringConverter extends Converter<List<LocalDateTime>, List<String>> {
  @override
  List<String> convert(List<LocalDateTime> input) {
    final localDateTimeConverter = LocalDateTimeToStringConverter();
    return input.map((ldt) => localDateTimeConverter.convert(ldt)).toList();
  }
}

/// Converts `List<String>` to `List<ZoneId>`
/// 
/// Example:
/// ```dart
/// final converter = ListStringToListZoneIdConverter();
/// final zoneIds = converter.convert(['UTC', 'America/New_York', 'Europe/London']);
/// ```
class ListStringToListZoneIdConverter extends Converter<List<String>, List<ZoneId>> {
  @override
  List<ZoneId> convert(List<String> input) {
    final stringConverter = StringToZoneIdConverter();
    return input.map((str) => stringConverter.convert(str)).toList();
  }
}

/// Converts `List<ZoneId>` to `List<String>`
/// 
/// Example:
/// ```dart
/// final converter = ListZoneIdToListStringConverter();
/// final strings = converter.convert([ZoneId.UTC, ZoneId.AMERICA_NEW_YORK]);
/// ```
class ListZoneIdToListStringConverter extends Converter<List<ZoneId>, List<String>> {
  @override
  List<String> convert(List<ZoneId> input) {
    final zoneIdConverter = ZoneIdToStringConverter();
    return input.map((zid) => zoneIdConverter.convert(zid)).toList();
  }
}
