...
void main() {
  ...
  group('UUID Converters', () {
    test('String to Uuid conversion - standard format', () {
      ...
      final result = service.convert<Uuid>(uuidString, Class.of<Uuid>());
    ...
    test('String to Uuid conversion throws on invalid format', () {
      expect(() => service.convert<Uuid>('invalid-uuid', Class.of<Uuid>()), 
    ...
    test('Uuid to String conversion', () {
      ...
      final result = service.convert<String>(uuid, Class.of<String>());
  ...
  group('Byte Multi Converter', () {
    test('Byte to String conversion', () {
      ...
      final result = service.convert<String>(byteData, Class.of<String>());
      expect(result, 'Hello World');
    });

    test('String to Byte conversion', () {
      final result = service.convert<Byte>('Test String', Class.of<Byte>());
      expect(result?.toString(), 'Test String');
    });

    test('Byte to List<int> conversion', () {
      final byteData = Byte.fromString('ABC');
      final result = service.convert<List<int>>(byteData, Class.of<List<int>>());
    ...
    test('List<int> to Byte conversion', () {
      ...
      final result = service.convert<Byte>(list, Class.of<Byte>());
      expect(result?.toString(), 'Hello');
    });

    test('Byte to Uint8List conversion', () {
      final byteData = Byte.fromString('Test');
      final result = service.convert<Uint8List>(byteData, Class.of<Uint8List>());
    ...
    test('Uint8List to Byte conversion', () {
      ...
      final result = service.convert<Byte>(uint8List, Class.of<Byte>());
      expect(result?.toString(), 'Test');
    });

    test('Empty List<int> to Byte conversion', () {
      final result = service.convert<Byte>(<int>[], Class.of<Byte>());
  ...
  group('Locale Converters', () {
    ...
    test('Locale to String conversion', () {
      ...
      final result = service.convert<String>(locale, Class.of<String>());
      expect(result, 'es-MX');
    });
